...
class MainMenuState extends MusicBeatState
{
	...
	public static var yoylecakinVersion:String = '0.0.1';
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Browsing JNJ", null);
		#end
		...
		add(fnfVer);
		var modVer:FlxText = new FlxText(12, FlxG.height - 24, 0, "YOYLECAKIN' v" + yoylecakinVersion, 12);
