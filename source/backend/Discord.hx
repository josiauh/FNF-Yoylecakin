...
class DiscordClient
{
	...
	private static final _defaultID:String = "1238732070302253086";
	...
	public static function changePresence(?details:String = 'Browsing JNJ', ?state:Null<String>, ?smallImageKey:String, ?hasStartTimestamp:Bool,
			?endTimestamp:Float)
	{
