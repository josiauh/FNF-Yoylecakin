...
class Achievements
{
	...
	{
		createAchievement('friday_night_play', {name: "Even More Freaky", description: "Play on a Friday... Night.", hidden: true});
		createAchievement('week1_nomiss', {name: "I'm Daddy", description: "Beat Week 1 on Hard with no Misses."});
		createAchievement('week2_nomiss', {name: "Spooped", description: "Beat Week 2 on Hard with no Misses."});
		createAchievement('week3_nomiss', {name: "Call Me The Hitman", description: "Beat Week 3 on Hard with no Misses."});
		createAchievement('week4_nomiss', {name: "Run Over", description: "Beat Week 4 on Hard with no Misses."});
		createAchievement('week5_nomiss', {name: "Gifted", description: "Beat Week 5 on Hard with no Misses."});
		createAchievement('week6_nomiss', {name: "SENPAI LOSE | BF WIN", description: "Beat Week 6 on Hard with no Misses."});
		createAchievement('week7_nomiss', {name: "Not So Tanked", description: "Beat Week 7 on Hard with no Misses."});
		createAchievement('ur_bad', {name: "HOW AM I NOT DEAD???", description: "Complete a Song with a rating lower than 20%."});
		...
		createAchievement('hype', {name: "Cherry Dr. Pepper", description: "Finish a Song without going back to Idle."});
		createAchievement('two_keys', {name: "Just the Two of Us", description: "Finish a Song pressing only two keys."});
		createAchievement('say_goodbye', {name: "Bleh", description: "Just, die?"});
		createAchievement('say_goodbye_2', {name: "Run Over", description: "Die in Week 6.", hidden: true});
